...
let SendMailRegister = (obj) =>{
    return new Promise((resolve, reject) => {
        ...
        var mailOptions = {
            ...
            "<p>Link: <a href='http://120.72.107.187/qooservice/index.php?page=mail_authente&emailCustomer=" + obj.email + "'>http://120.72.107.187/qooservice/index.php?page=mail_authente</a></p>" +
            "<p>Thanks,</p>"
        };
